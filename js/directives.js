...
enableAppDirectives.directive("enableQuiz", ['$http', '$route', '$timeout', '$sce', function($http, $route, $timeout, $sce) {
    var linker = function(scope) {
        ...
        scope.quizpoll = {
            ...
            "summarypass" : "Pass summary text goes here",
            "summaryfail" : "Fail summary text goes here",
            "type" : "quiz",
            "language" : "nn",
            "exam_type" : "quizpoll",
            "module_description" : "",
            ...
            "questions": [
                ...
                },
                {
                    ...
                    "answers": [
                        {
                            "text": "Agree",
                            "correct_feedback": "Inclusion can foster understanding and acceptance. But does it always work that way? What if the groups’ attitude towards children with disabilities is really bad? Do you think a child with disabilities put in the classroom can change this? One of the most important things for humans with disabilities is the attitude among people surrounding them. Attitude doesn’t change just because you include a child with disabilities in the class.  What do you think is important to change people attitude?",
                            "incorrect_feedback": "",
                            "image_url": "",
                            "correct" : true
                        },
